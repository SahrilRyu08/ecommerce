...
assertEqual 3 $(echo $RESPONSE | jq ".recommendationSummaryList | length")
assertEqual 3 $(echo $RESPONSE | jq ".reviewSummaryList| length")
...
assertEqual 0 $(echo $RESPONSE | jq ".recommendationSummaryList | length")
assertEqual 3 $(echo $RESPONSE | jq ".reviewSummaryList | length")
...
assertEqual 3 $(echo $RESPONSE | jq ".recommendationSummaryList | length")
assertEqual 0 $(echo $RESPONSE | jq ".reviewSummaryList | length")
